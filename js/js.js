...
$('.delete').live("click",function(){var xfile=$(this).parent().text();if(confirm("Вы точно хотите удалить файл \""+xfile.substring(34,xfile.length-29)+"\"?")){location.replace($(this).attr('hyref'));}});//Подтверждение удаления файла
$('#deletenews').live("click",function(){if(confirm("Вы точно хотите удалить эту новость?")){location.replace($(this).attr('hyref'));}});
$('#deletebook').live("click",function(){if(confirm("Вы точно хотите удалить эту книгу?")){location.replace($(this).attr('hyref'));}});
$('#deleteuser').live("click",function(){if(confirm("Вы точно хотите удалить этого пользователя?")){location.replace($(this).attr('hyref'));}});
